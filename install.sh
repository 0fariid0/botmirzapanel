...
if [[ "$1" == "-v" && "$2" == "beta" ]] || [[ "$1" == "-beta" ]] || [[ "$1" == "-" && "$2" == "beta" ]]; then
    ...
    ZIP_URL="https://github.com/0fariid0/botmirzapanel/archive/refs/tags/$2.zip"
else
...
${ASAS}dsn = "mysql:host=localhost;port=3306;dbname=\$dbname;charset=utf8mb4";
try {
...
EOF"
    ...
    git clone https://github.com/0fariid0/botmirzapanel.git "$BOT_DIR" || {
...
function update_additional_bot() {
    ...
    if ! git clone https://github.com/0fariid0/botmirzapanel.git "$BOT_PATH"; then
